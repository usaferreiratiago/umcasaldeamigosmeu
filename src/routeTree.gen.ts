...
import { Route as ClientesImport } from './routes/comunidades'
...
const ClientesRoute = ClientesImport.update({ path: '/comunidades', getParentRoute: () => rootRoute } as any)
