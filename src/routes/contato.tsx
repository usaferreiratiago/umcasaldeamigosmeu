...
//       );
//       window.open(`https://wa.me/34662433882?text=${text}`, "_blank");
//       reset();
//     }
//   };
...
//                 >
//                   <Mail className="h-4 w-4 transition-transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5" />
//                   Enviar por e-mail
//                 </button>
...
//                 {/* Botão: LinkedIn */}
//                 <a
//                   href="https://linkedin.com/company" /* Substitua com o link correto */
//                   target="_blank"
          ...
          >
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center pt-2 border-t border-zinc-200 dark:border-zinc-800">
                ...
                {/* Botão: Instagram */}
                <a
                  href="https://instagram.com/umcasaldeamigosmeu"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group inline-flex w-full items-center justify-center gap-3 rounded-sm border border-pink-600/30 bg-pink-50/50 hover:bg-pink-600 dark:border-pink-500/20 dark:bg-pink-950/20 dark:hover:bg-pink-600 px-6 py-3 text-sm font-medium text-pink-700 dark:text-pink-400 hover:text-white dark:hover:text-white transition-all md:w-auto cursor-pointer"
                >
                ...
                {/* Botão: YouTube */}
                <a
                  href="https://youtube.com/@umcasaldeamigosmeu"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group inline-flex w-full items-center justify-center gap-3 rounded-sm border border-red-600/30 bg-red-50/50 hover:bg-red-600 dark:border-red-500/20 dark:bg-red-950/20 dark:hover:bg-pink-600 px-6 py-3 text-sm font-medium text-red-700 dark:text-red-400 hover:text-white dark:hover:text-white transition-all md:w-auto cursor-pointer"
                >
