        ...
        <div className="relative mx-auto grid min-h-[calc(100vh-4rem)] max-w-7xl grid-cols-12 gap-6 px-6 pb-16 pt-24 lg:px-10">
          <div className="col-span-12 flex flex-col justify-end lg:col-span-9">
            ...
            >
              <Link
                to="/contato"
                className="group inline-flex items-center gap-3 rounded-sm bg-blue-700 dark:bg-blue-600 px-6 py-3.5 text-sm font-medium text-white transition hover:bg-blue-800 dark:hover:bg-blue-500 shadow-md"
              >
                Fale conosco
